...
sf::Texture Enemy::s_tex1;
sf::Texture Enemy::s_tex2;
...
{
    ensureTexture(type);
    sf::Texture& tex = (type == TextureType::Enemy1) ? s_tex1 : s_tex2;
    m_sprite = std::make_unique<sf::Sprite>(tex, IntRect({0,0}, {20,20}));
